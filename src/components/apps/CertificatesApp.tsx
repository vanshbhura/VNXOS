          ...
          <div className="space-y-6">
            {certificatesData.map((cert) => (
              ...
              >
                ...
                <div className="w-full md:w-60 h-44 md:h-auto bg-slate-900/80 border-b md:border-b-0 md:border-r border-white/10 flex-shrink-0 flex items-center justify-center overflow-hidden p-4">
                  <CertPreview src={cert.assetPath} alt={cert.name} />
                </div>

                {/* Certificate Information (Right) */}
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-3 border-t border-white/5 mt-auto">
                    {(cert.certificatePdf || cert.assetPath) && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-emerald-600/90 hover:bg-emerald-500 text-white text-xs md:text-sm font-medium transition-colors border border-emerald-500/50"
                      >
                        <FileText size={14} />
                        View Certificate
                      </a>
                    ...
                    {cert.credentialUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs md:text-sm font-medium transition-colors border border-slate-700"
                      >
